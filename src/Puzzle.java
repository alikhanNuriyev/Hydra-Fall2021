...
public class Puzzle {
	...
	public Puzzle(int puzzleId, int roomId, int puzzleName, String puzzleDescription, String puzzleAnswer, String puzzleHint, int attempts) {
